...
- Documentación completa en español e inglés: https://www.maosuarez.com/docs/caligrama. Enlazada desde el README y como `Documentation` en los metadatos del paquete (PyPI).
...
[Sin publicar]: https://github.com/maosuarez/caligrama/compare/v0.3.2...HEAD
[0.3.2]: https://github.com/maosuarez/caligrama/compare/v0.3.1...v0.3.2
